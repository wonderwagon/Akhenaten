package com.github.dalerank.ozymandias;
...
public class FileManager {
    ...
    static int setBaseUri(Uri newUri) {
        try {
            ...
            Log.e("ozymandias", "Error in setBaseUri: " + e);
            return 0;
        }
    }
    ...
    private static FileInfo getFileFromPath(OzymandiasMainActivity activity, String filePath) {
        try {
            ...
            Log.e("ozymandias", "Error in getFileFromPath: " + e);
            return null;
        }
    }

    @SuppressWarnings("unused")
    public static FileInfo[] getDirectoryFileList(OzymandiasMainActivity activity, String dir, int type, String ext) {
    ...
    public static boolean deleteFile(OzymandiasMainActivity activity, String filePath) {
        try {
            ...
            Log.e("ozymandias", "Error in deleteFile: " + e);
            return false;
        }
    }

    @SuppressWarnings("unused")
    public static int openFileDescriptor(OzymandiasMainActivity activity, String filePath, String mode) {
        try {
            if (baseUri == Uri.EMPTY) {
                return 0;
            }
