...
building_sounds = [
  ...
  { type: BUILDING_POMEGRANATES_FARM,	sound: "Wavs/pomfarm.wav"},
	...
	{ type: BUILDING_HOUSE_CRUDE_HUT,		sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_STURDY_HUT,	sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_MEAGER_SHANTY,	sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_COMMON_SHANTY,	sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_ROUGH_COTTAGE,	sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_ORDINARY_COTTAGE,	sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_MODEST_HOMESTEAD,	sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_SPACIOUS_HOMESTEAD,	sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_MODEST_APARTMENT,	sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_SPACIOUS_APARTMENT,	sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_COMMON_RESIDENCE,	sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_SPACIOUS_RESIDENCE,	sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_ELEGANT_RESIDENCE,	sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_FANCY_RESIDENCE,	sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_COMMON_MANOR,	sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_SPACIOUS_MANOR,	sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_ELEGANT_MANOR,	sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_STATELY_MANOR,	sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_MODEST_ESTATE,	sound: "Wavs/housing.wav"},
	{ type: BUILDING_HOUSE_PALATIAL_ESTATE,	sound: "Wavs/housing.wav"},
]
