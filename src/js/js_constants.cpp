...
void js_register_city_walkers(js_State *J) {
   ...
   REGISTER_GLOBAL_CONSTANT(J, FIGURE_SCHOOL_CHILD);
   ...
   REGISTER_GLOBAL_CONSTANT(J, FIGURE_FISH_GULLS);
...
void js_register_city_buildings(js_State *J) {
   ...
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_HOUSE_SMALL_CASA);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_HOUSE_LARGE_CASA);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_HOUSE_SMALL_INSULA);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_HOUSE_MEDIUM_INSULA);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_HOUSE_LARGE_INSULA);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_HOUSE_GRAND_INSULA);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_HOUSE_SMALL_VILLA);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_HOUSE_MEDIUM_VILLA);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_HOUSE_LARGE_VILLA);
   ...
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_SCHOOL);
...
void js_register_city_overlays(js_State *J) {
   ...
   REGISTER_GLOBAL_CONSTANT(J, OVERLAY_SCHOOL);
