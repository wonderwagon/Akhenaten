...
void js_register_city_images(js_State *J) {
   ...
   REGISTER_GLOBAL_CONSTANT(J, IMG_SIDE_PANEL);
   REGISTER_GLOBAL_CONSTANT(J, IMG_TOP_MENU_BACKGROUND);
   REGISTER_GLOBAL_CONSTANT(J, IMG_EDITOR_SIDE_PANEL);
   REGISTER_GLOBAL_CONSTANT(J, IMG_RESOURCE_PAPYRUS);
   REGISTER_GLOBAL_CONSTANT(J, IMG_EMPIRE_ROUTE_HL_CLOSED);
   REGISTER_GLOBAL_CONSTANT(J, IMG_EMPIRE_ROUTE_OPEN);
   REGISTER_GLOBAL_CONSTANT(J, IMG_EMPIRE_ROUTE_HL_OPEN);
   REGISTER_GLOBAL_CONSTANT(J, IMG_MINIMAP_BLACK);
   REGISTER_GLOBAL_CONSTANT(J, IMG_MINIMAP_BRIGHT_TEAL);
   REGISTER_GLOBAL_CONSTANT(J, IMG_MINIMAP_DARK_GREY);
   REGISTER_GLOBAL_CONSTANT(J, IMG_MINIMAP_GREEN);
   REGISTER_GLOBAL_CONSTANT(J, IMG_MINIMAP_DARK_RED);
   REGISTER_GLOBAL_CONSTANT(J, IMG_MINIMAP_PURPLE);
   REGISTER_GLOBAL_CONSTANT(J, IMG_MINIMAP_LIGHT_YELLOW);
}
...
void js_register_collection_images(js_State *J) {
   ...
   REGISTER_GLOBAL_CONSTANT(J, IMG_MINIMAP_BRIGHT_BLUE);
   REGISTER_GLOBAL_CONSTANT(J, IMG_MINIMAP_LILAC);
   REGISTER_GLOBAL_CONSTANT(J, IMG_MINIMAP_ORANGE);
   REGISTER_GLOBAL_CONSTANT(J, IMG_MINIMAP_SPENT_TEAL);
   REGISTER_GLOBAL_CONSTANT(J, IMG_MINIMAP_COLOR);
}
