...
void js_register_city_buildings(js_State *J) {
   ...
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_MENU_CONSTURCTION_GUILDS);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_ROAD);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_MUD_WALL);
   ...
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_SENET_MASTER);
   ...
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_RESERVED_TRIUMPHAL_ARCH_56);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_MENU_FORTS);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_MUD_GATEHOUSE);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_MUD_TOWER);
   ...
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_MENU_EDUCATION);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_MENU_WATER_CROSSINGS);
   ...
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_MONUMENT_NONE);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_SMALL_BENT_PYRAMID);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_MEDIUM_BENT_PYRAMID);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_SMALL_MUDBRICK_PYRAMID);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_MEDIUM_MUDBRICK_PYRAMID);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_LARGE_MUDBRICK_PYRAMID);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_MUDBRICK_PYRAMID_COMPLEX);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_GRAND_MUDBRICK_PYRAMID_COMPLEX);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_SMALL_STEPPED_PYRAMID);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_MEDIUM_STEPPED_PYRAMID);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_LARGE_STEPPED_PYRAMID);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_STEPPED_PYRAMID_COMPLEX);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_GRAND_STEPPED_PYRAMID_COMPLEX);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_SMALL_PYRAMID);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_MEDIUM_PYRAMID);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_LARGE_PYRAMID);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_PYRAMID_COMPLEX);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_GRAND_PYRAMID_COMPLEX);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_SMALL_MASTABA);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_MEDIUM_MASTABA);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_LARGE_MASTABA);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_SPHINX);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_SMALL_OBELISK);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_LARGE_OBELISK);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_SUN_TEMPLE);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_MAUSOLEUM);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_MAUSOLEUM_1);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_MAUSOLEUM_2);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_PHAROS_LIGHTHOUSE);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_ALEXANDRIAS_LIBRARY);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_CAESAREUM);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_COLOSSI);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_TEMPLE_OF_LUXOR);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_SMALL_ROYAL_BURIAL_TOMB);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_MEDIUM_ROYAL_BURIAL_TOMB);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_LARGE_ROYAL_BURIAL_TOMB);
   REGISTER_GLOBAL_CONSTANT(J, BUILDING_GRAND_ROYAL_BURIAL_TOMB);
