...
void js_register_menu(js_State *J) {
   _R(BUILD_MENU_VACANT_HOUSE)
   _R(BUILD_MENU_CLEAR_LAND)
   _R(BUILD_MENU_ROAD)
   _R(BUILD_MENU_WATER_CROSSINGS)
   _R(BUILD_MENU_HEALTH)
   _R(BUILD_MENU_RELIGION)
   _R(BUILD_MENU_EDUCATION)
   _R(BUILD_MENU_ENTERTAINMENT)
   _R(BUILD_MENU_ADMINISTRATION)
   _R(BUILD_MENU_BEAUTIFICATION)
   _R(BUILD_MENU_SECURITY)
   _R(BUILD_MENU_INDUSTRY)
   _R(BUILD_MENU_FARMS)
   _R(BUILD_MENU_RAW_MATERIALS)
   _R(BUILD_MENU_GUILDS)
   _R(BUILD_MENU_TEMPLES)
   _R(BUILD_MENU_LARGE_TEMPLES)
   _R(BUILD_MENU_TEMPLE_COMPLEX)
   _R(BUILD_MENU_FORTS)
   _R(BUILD_MENU_FOOD)
   _R(BUILD_MENU_DISTRIBUTION)
   _R(BUILD_MENU_SHRINES)
   _R(BUILD_MENU_MONUMENTS)
   _R(BUILD_MENU_DEFENCES)
}
