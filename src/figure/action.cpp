...
static figure_action_property action_properties_lookup[] = {
  ...
  {FIGURE_TAX_COLLECTOR, 1, TERRAIN_USAGE_ROADS, 512, 0, 0, IMG_NONE},
  {FIGURE_ARCHITECT, 1, TERRAIN_USAGE_ROADS, 640, 0, 0, IMG_NONE},
  ...
  {FIGURE_MARKET_TRADER, 1, TERRAIN_USAGE_ROADS, 384, 0, 0, IMG_NONE},
  ...
  {FIGURE_PHYSICIAN, 1, TERRAIN_USAGE_ROADS, 384, 0, 0, IMG_NONE},
  ...
  {FIGURE_OSTRICH_HUNTER, 1, TERRAIN_USAGE_ANIMAL, 0, 0, 0, IMG_NONE},
