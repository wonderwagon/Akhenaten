...
static figure_action_property action_properties_lookup[] = {
  ...
  {FIGURE_INFANTRY, 1, 0, 0, IMG_NONE},
  {FIGURE_STANDARD_BEARER, 1, 0, 0, 0},
  {FIGURE_JUGGLER, 1, 0, 0, 0, IMG_NONE},
  {FIGURE_MUSICIAN, 1, 0, 0, 0, IMG_NONE},
  {FIGURE_DANCER, 1, 0, 0, 0, ANIM_DANCER_WALK},
  {FIGURE_SENET_PLAYER, 1, 0, GROUP_FIGURE_CHARIOTEER},
  {FIGURE_TRADE_CARAVAN, 1, 0, 0, 0, IMG_TRADER_CARAVAN},
  {FIGURE_TRADE_SHIP, 1, 0, 0, 0, ANIM_TRADER_SHIP_WALK},
  {FIGURE_TRADE_CARAVAN_DONKEY, 1, 0, 0, 0, IMG_TRADER_CARAVAN_DONKEY},
  ...
  {FIGURE_WORKER, 1, 0, 0, 0},
  {FIGURE_MAP_FLAG, 1, 0, 0, 0},
  {FIGURE_FLOTSAM, 1, 0, 0, 0},
  {FIGURE_DOCKER, 1, 0, 0, 0, ANIM_DOCKER_WALK},
  {FIGURE_MARKET_BUYER, 1, 800, 0, 0, ANIM_MARKET_BUYER_WALK},
