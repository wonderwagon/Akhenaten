...
static figure_action_property action_properties_lookup[] = {
  ...
  {FIGURE_TAX_COLLECTOR, 1, TERRAIN_USAGE_ROADS, 512, GROUP_FIGURE_TAX_COLLECTOR},
  {FIGURE_ENGINEER, 1, TERRAIN_USAGE_ROADS, 640, GROUP_FIGURE_ENGINEER},
  {FIGURE_STORAGE_YARD_DELIVERCART, 1, TERRAIN_USAGE_ROADS, 0, GROUP_FIGURE_CARTPUSHER},
  {FIGURE_FIREMAN, 1, TERRAIN_USAGE_ROADS, 640, GROUP_FIGURE_FIREMAN},
  {FIGURE_FORT_ARCHER, 1, TERRAIN_USAGE_ANY, 0, GROUP_FIGURE_ARCHER_PH},
  {FIGURE_FORT_SPEARMAN, 1, TERRAIN_USAGE_ANY, 0, GROUP_FIGURE_CHARIOTEER_PH},
  {FIGURE_FORT_CHARIOT, 1, TERRAIN_USAGE_ANY, 0, GROUP_FIGURE_INFANTRY_PH},
  {FIGURE_FORT_STANDARD, 1, TERRAIN_USAGE_ANY, 0, 0, 0},
  {FIGURE_JUGGLER, 1, TERRAIN_USAGE_ROADS, 512, GROUP_FIGURE_JUGGLER},
  {FIGURE_MUSICIAN, 1, TERRAIN_USAGE_ROADS, 512, GROUP_FIGURE_MUSICIAN},
  ...
  {FIGURE_TRADE_CARAVAN, 1, TERRAIN_USAGE_PREFER_ROADS, 0, GROUP_FIGURE_TRADE_CARAVAN},
  {FIGURE_TRADE_SHIP, 1, TERRAIN_USAGE_ANY, 0, 0, 0},
  {FIGURE_TRADE_CARAVAN_DONKEY, 1, TERRAIN_USAGE_PREFER_ROADS, 0, GROUP_FIGURE_TRADE_CARAVAN_DONKEY},
  ...
  {FIGURE_SCHOOL_CHILD, 1, TERRAIN_USAGE_ROADS, 192, GROUP_FIGURE_SCHOOL_CHILD},
  {FIGURE_TEACHER, 1, TERRAIN_USAGE_ROADS, 384, GROUP_FIGURE_TEACHER_LIBRARIAN},
  {FIGURE_LIBRARIAN, 1, TERRAIN_USAGE_ROADS, 384, GROUP_FIGURE_TEACHER_LIBRARIAN},
  ...
  {FIGURE_PATRICIAN, 1, TERRAIN_USAGE_ROADS, 128, GROUP_FIGURE_PATRICIAN},
  ...
  {FIGURE_FISH_GULLS, 1, TERRAIN_USAGE_ANY, 0, GROUP_FIGURE_SEAGULLS},
  ...
  {FIGURE_OSTRICH, 2, TERRAIN_USAGE_ANIMAL, 0, GROUP_FIGURE_OSTRICH_WALK},
  ...
  {76, 1, TERRAIN_USAGE_ANY, 0, 0, 0},
  {77, 1, TERRAIN_USAGE_ROADS, 0, 0, 0},
