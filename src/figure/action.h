...
enum {
    ...
    // pharaoh
    FIGURE_ACTION_LABORSEEKER_ROAM,
    FIGURE_ACTION_LABORSEEKER_RETURN,
    FIGURE_ACTION_COMMON_ROAM,
    FIGURE_ACTION_COMMON_RETURN,
...
//    FIGURE_ACTION_202_HIPPODROME_HORSE_DONE, 202,
    ...
    FIGURE_ACTION_LABORSEEKER_ROAM, 1,
    FIGURE_ACTION_LABORSEEKER_RETURN, 2,
    FIGURE_ACTION_COMMON_ROAM, 10,
    FIGURE_ACTION_COMMON_RETURN, 11,
