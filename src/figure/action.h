...
enum e_figure_action {
    ...
    FIGURE_ACTION_10_BRIRKLAYER_GOING = 10,
    FIGURE_ACTION_11_BRICKLAYER_GOING_TO_PLACE = 11,
    FIGURE_ACTION_12_BRICKLAYER_WAITING_RESOURCES = 12,
    FIGURE_ACTION_13_BRICKLAYER_LAY_BRICKS = 13,
    FIGURE_ACTION_14_BRICKLAYER_LOOKING_FOR_IDLE_TILE = 14,
    ...
    ACTION_10_REED_GATHERER_RETURN_HOME = 11,
