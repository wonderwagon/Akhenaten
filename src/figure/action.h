...
enum e_figure_action {
    ...
    FIGURE_ACTION_11_FESTIVAL_PRIEST_GOTO_SQUARE = 11,
    FIGURE_ACTION_12_FESTIVAL_PRIEST_DANCE = 12,
    FIGURE_ACTION_13_FESTIVAL_PRIEST_GOTO_HOME = 13,
    ...
    FIGURE_ACTION_13_WORKER_BACK_FROM_WORKS = 13,
    ...
    FIGURE_ACTION_60_WAREHOUSEMAN_UNLOADING_AT_HOME = 60,
    ...
    FIGURE_ACTION_104_TRADE_CARAVAN_RECALC_LEAVING = 104,
    ...
    ACTION_12_HUNTER_MOVE_PACKED = 12,
