...
typedef enum figure_type {
    ...
    FIGURE_ACTOR = 15, FIGURE_JUGGLER = 15,
    FIGURE_GLADIATOR = 16, FIGURE_MUSICIAN = 16,
    FIGURE_LION_TAMER = 17, FIGURE_DANCER = 17,
    ...
    FIGURE_TEACHER = 29,
    FIGURE_LIBRARIAN = 30,
    FIGURE_BARBER = 31, FIGURE_DENTIST = 31,
    FIGURE_BATHHOUSE_WORKER = 32, //FIGURE_PHYSICIAN = 32,
    FIGURE_DOCTOR = 33, //FIGURE_PHYSICIAN = 33,
    FIGURE_SURGEON = 34,
    FIGURE_WORKER = 35,
    FIGURE_MAP_FLAG = 36,
    FIGURE_FLOTSAM = 37,
