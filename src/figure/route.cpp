    ...
    if (is_boat) {
        ...
        case TERRAIN_USAGE_ENEMY:
            ...
            if (!can_travel) {
                ...
                if (!can_travel)
                    can_travel = map_routing_noncitizen_can_travel_through_everything(tile.x(),
                                                                                      tile.y(),
                                                                                      destination_tile.x(),
                                                                                      destination_tile.y());
            }
        ...
        case TERRAIN_USAGE_PREFER_ROADS:
            can_travel = map_routing_citizen_can_travel_over_road(tile.x(),
                                                                  tile.y(),
                                                                  destination_tile.x(),
                                                                  destination_tile.y());
            if (!can_travel)
                can_travel = map_routing_citizen_can_travel_over_land(tile.x(),
                                                                      tile.y(),
                                                                      destination_tile.x(),
                                                                      destination_tile.y());
            break;
