...
io_buffer *iob_city_data = new io_buffer([](io_buffer *iob) {
    ...
    iob->bind(BIND_SIGNATURE_INT32, &city_data.taxes.taxed_plebs);
    iob->bind(BIND_SIGNATURE_INT32, &city_data.taxes.taxed_patricians);
    iob->bind(BIND_SIGNATURE_INT32, &city_data.taxes.untaxed_plebs);
    iob->bind(BIND_SIGNATURE_INT32, &city_data.taxes.untaxed_patricians);
    iob->bind(BIND_SIGNATURE_INT32, &city_data.taxes.percentage_taxed_plebs);
    iob->bind(BIND_SIGNATURE_INT32, &city_data.taxes.percentage_taxed_patricians);
    iob->bind(BIND_SIGNATURE_INT32, &city_data.taxes.percentage_taxed_people);
    iob->bind(BIND_SIGNATURE_INT32, &city_data.taxes.yearly.collected_plebs);
    iob->bind(BIND_SIGNATURE_INT32, &city_data.taxes.yearly.collected_patricians);
    iob->bind(BIND_SIGNATURE_INT32, &city_data.taxes.yearly.uncollected_plebs);
    iob->bind(BIND_SIGNATURE_INT32, &city_data.taxes.yearly.uncollected_patricians);
    ...
    iob->bind(BIND_SIGNATURE_INT32, &city_data.taxes.monthly.collected_plebs);
    iob->bind(BIND_SIGNATURE_INT32, &city_data.taxes.monthly.uncollected_plebs);
    iob->bind(BIND_SIGNATURE_INT32, &city_data.taxes.monthly.collected_patricians);
    iob->bind(BIND_SIGNATURE_INT32, &city_data.taxes.monthly.uncollected_patricians);
...
//        city_data.religion.gods[i].unused3 = main->read_i8();
    for (int i = 0; i < MAX_GODS; i++)
        iob->bind(BIND_SIGNATURE_INT32, &city_data.religion.gods[i].months_since_festival);
