...
enum {
    ...
    GROUP_BUILDING_VILLAGE_PALACE = 47 + 66 + 99999, // general
    GROUP_BUILDING_TOWN_PALACE = 39 + 66 + 99999,
    GROUP_BUILDING_CITY_PALACE = 18 + 66 + 99999,
    GROUP_BUILDING_ROADBLOCK = 98 + 66 + 99999,
    GROUP_BUILDING_FARM_CROPS_PH = 100 + 66 + 99999,
    GROUP_SINGLE_SQUARE = 107 + 66 + 99999,
    GROUP_BOOTH_SQUARE = 112 + 66 + 99999,
    GROUP_BANDSTAND_SQUARE = 58 + 66 + 99999,
    GROUP_PAVILLION_SQUARE = 50 + 66 + 99999,
    GROUP_FESTIVAL_SQUARE = 49 + 66 + 99999,
    ...
    GROUP_WATER_LIFT = 1 + 555 + 99999, // sprambient
    GROUP_GRANARY_ANIM_PH = 47 + 555 + 99999,
    GROUP_WAREHOUSE_ANIM_PH = 51 + 555 + 99999,
//    GROUP_DOCK_WAITING = 55 + 555 + 99999,
//    GROUP_DOCK_UNLOADING = 56 + 555 + 99999,
    GROUP_MINES = 48 + 555 + 99999,
//    GROUP_DANCERS = 6 + 555 + 99999,
//    GROUP_JUGGLERS = 7 + 555 + 99999,
//    GROUP_MUSICIANS = 9 + 555 + 99999,
    GROUP_FIGURE_FISH = 8 + 555 + 99999,
    GROUP_FIGURE_HIPPO = 22 + 555 + 99999,
    GROUP_FIGURE_ANTILOPE = 30 + 555 + 99999,
    GROUP_FIGURE_HUNTER2 = 36 + 555 + 99999,
    GROUP_SHIP_BUILDING_1 = 45 + 555 + 99999,
    GROUP_SHIP_BUILDING_2 = 52 + 555 + 99999,
    GROUP_SHIP_BUILDING_3 = 53 + 555 + 99999,
    GROUP_SHIP_BUILDING_4 = 54 + 555 + 99999,
...
//    GROUP_SIDEBAR_BUTTONS_PH = 136+66,
    ...
    GROUP_TERRAIN_GRASS_PH = 46 + 99999, // terrain
    GROUP_TERRAIN_DEEPWATER = 61 + 99999,
    GROUP_TERRAIN_GRASS_PH_EDGES = 64 + 99999,
    GROUP_TERRAIN_FLOODPLAIN = 31 + 99999,
    GROUP_TERRAIN_FLOODSYSTEM = 33 + 99999,

    GROUP_DEBUG_ARROWPOST = 24 + 99999,
    GROUP_DEBUG_WIREFRAME_TILE = 41 + 99999,
    GROUP_SUNKEN_TILE = 20 + 99999,
