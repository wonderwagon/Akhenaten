...
//    GROUP_SIDE_PANEL_PH = 121 + GENERAL_OFFSET,
//    GROUP_SIDEBAR_BUTTONS_PH = 136 + GENERAL_OFFSET,
    GROUP_PANEL_WINDOWS_PH = 300,
    GROUP_MESSAGE_ADVISOR_BUTTONS_BIG = 128 + GENERAL_OFFSET + PHARAOH_FORCE_OFFSET,
