...
#define GROUP_BUILDING_TEMPLE_COMPLEX_OSIRIS  IMAGE_COLLECTION_MONUMENT,  760
#define GROUP_BUILDING_TEMPLE_COMPLEX_RA  IMAGE_COLLECTION_MONUMENT,  774
#define GROUP_BUILDING_TEMPLE_COMPLEX_PTAH  IMAGE_COLLECTION_MONUMENT,  767
#define GROUP_BUILDING_TEMPLE_COMPLEX_SETH  IMAGE_COLLECTION_MONUMENT,  781
#define GROUP_BUILDING_TEMPLE_COMPLEX_BAST  IMAGE_COLLECTION_MONUMENT,  753
