...
static const int UNLOADED_OFFSET = 294;
static const int FONTS_OFFSET = 332;
static const int SPR_MAIN_OFFSET = 341;
static const int SPR_AMBIENT_OFFSET = 555;

enum {
    IMAGE_COLLECTION_TERRAIN = 0,
    IMAGE_COLLECTION_GENERAL = 1,
    IMAGE_COLLECTION_UNLOADED = 2,
    IMAGE_COLLECTION_EMPIRE = 3,
    IMAGE_COLLECTION_SPR_MAIN = 4,
    IMAGE_COLLECTION_SPR_AMBIENT = 5,
    //
    IMAGE_COLLECTION_ENEMY = 6,
    IMAGE_COLLECTION_FONT = 7,
    //
    IMAGE_COLLECTION_EXPANSION = 8,
    IMAGE_COLLECTION_EXPANSION_SPR = 9,
    //
    IMAGE_COLLECTION_MASTABA = 10,
};
...
#define GROUP_TERRAIN_ELEVATION_ROCK  IMAGE_COLLECTION_TERRAIN,  8
...
#define GROUP_BUILDING_WALL  IMAGE_COLLECTION_TERRAIN,  24
#define GROUP_BUILDING_RESERVOIR  IMAGE_COLLECTION_TERRAIN,  50 //25
#define GROUP_BUILDING_SHIPYARD  IMAGE_COLLECTION_TERRAIN,  26 //77
#define GROUP_BUILDING_DOCK_1  IMAGE_COLLECTION_TERRAIN,  49 //78
#define GROUP_BUILDING_WHARF  IMAGE_COLLECTION_TERRAIN,  18 //79
...
#define GROUP_TERRAIN_MEADOW  IMAGE_COLLECTION_TERRAIN,  46 //138
#define GROUP_BUILDING_BRIDGE  IMAGE_COLLECTION_TERRAIN,  63 //164
#define GROUP_BUILDING_DOCK_2  IMAGE_COLLECTION_TERRAIN,  65 //168
#define GROUP_BUILDING_DOCK_3  IMAGE_COLLECTION_TERRAIN,  50 //169 <----- ??????????????????
#define GROUP_BUILDING_DOCK_4  IMAGE_COLLECTION_TERRAIN,  63 //170 <----- ??????????????????
...
#define GROUP_SYSTEM_GRAPHICS  IMAGE_COLLECTION_GENERAL,  0
...
#define GROUP_BUILDING_MARBLE_QUARRY  IMAGE_COLLECTION_GENERAL,  187 //38
#define GROUP_BUILDING_IRON_MINE  IMAGE_COLLECTION_GENERAL,  170 //39
...
#define GROUP_BUILDING_STATUE  IMAGE_COLLECTION_GENERAL,  61
...
#define GROUP_BUILDING_DOCTOR  IMAGE_COLLECTION_GENERAL,  68
...
//#define ?????  IMAGE_COLLECTION_UNLOADED,  6 //186
//#define ?????  IMAGE_COLLECTION_UNLOADED,  5 //187
//#define ?????  IMAGE_COLLECTION_UNLOADED,  4 //188
#define GROUP_BIG_PEOPLE  IMAGE_COLLECTION_UNLOADED,  25 //190
...
#define GROUP_FIGURE_MIGRANT  IMAGE_COLLECTION_SPR_MAIN,  13 //108
...
#define GROUP_WATER_LIFT  IMAGE_COLLECTION_SPR_AMBIENT,  1 // sprambient
...
#define GROUP_BUILDING_TEMPLE_COMPLEX_BAST  IMAGE_COLLECTION_MASTABA,  753
#define GROUP_BUILDING_TEMPLE_COMPLEX_OSIRIS  IMAGE_COLLECTION_MASTABA,  760
#define GROUP_BUILDING_TEMPLE_COMPLEX_PTAH  IMAGE_COLLECTION_MASTABA,  767
#define GROUP_BUILDING_TEMPLE_COMPLEX_RA  IMAGE_COLLECTION_MASTABA,  774
#define GROUP_BUILDING_TEMPLE_COMPLEX_SETH  IMAGE_COLLECTION_MASTABA,  781
