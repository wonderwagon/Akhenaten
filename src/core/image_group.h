...
static const int PHARAOH_OFFSET = 99999;
...
enum {
    ...
    GROUP_BUILDING_VILLAGE_PALACE = 47 + GENERAL_OFFSET + PHARAOH_OFFSET, // general
    GROUP_BUILDING_TOWN_PALACE = 39 + GENERAL_OFFSET + PHARAOH_OFFSET,
    GROUP_BUILDING_CITY_PALACE = 18 + GENERAL_OFFSET + PHARAOH_OFFSET,
    GROUP_BUILDING_ROADBLOCK = 98 + GENERAL_OFFSET + PHARAOH_OFFSET,
    GROUP_BUILDING_FARM_CROPS_PH = 100 + GENERAL_OFFSET + PHARAOH_OFFSET,
    GROUP_SINGLE_SQUARE = 107 + GENERAL_OFFSET + PHARAOH_OFFSET,
    GROUP_BOOTH_SQUARE = 112 + GENERAL_OFFSET + PHARAOH_OFFSET,
    GROUP_BANDSTAND_SQUARE = 58 + GENERAL_OFFSET + PHARAOH_OFFSET,
    GROUP_PAVILLION_SQUARE = 50 + GENERAL_OFFSET + PHARAOH_OFFSET,
    GROUP_FESTIVAL_SQUARE = 49 + GENERAL_OFFSET + PHARAOH_OFFSET,


    GROUP_PRIEST_OSIRIS = 197 + 341 + 99999, // sprmain
    GROUP_PRIEST_RA = 210 + 341 + 99999,
    GROUP_PRIEST_SETH = 193 + 341 + 99999,
    GROUP_PRIEST_PTAH = 187 + 341 + 99999,
    GROUP_PRIEST_BAST = 208 + 341 + 99999,
    GROUP_FIGURE_MARKET_LADY_2 = 18 + 341 + 99999,
    GROUP_FIGURE_POLICEMAN = 20 + 341 + 99999,
    GROUP_FIGURE_REED_GATHERER = 37 + 341 + 99999,
    GROUP_FIGURE_HUNTER = 45 + 341 + 99999,
    GROUP_FIGURE_HUNTER_ARROW = 0 + 341 + 99999,
    GROUP_FIGURE_TRADE_CARAVAN_DONKEY = 52 + 341 + 99999,
    GROUP_FIGURE_WATER_CARRIER = 59 + 341 + 99999,
    GROUP_FIGURE_WORKER_PH = 116 + 341 + 99999,
    GROUP_FIGURE_MORTUARY = 195 + 341 + 99999,
    GROUP_FIGURE_MAGISTRATE = 212 + 341 + 99999,

    GROUP_WATER_LIFT = 1 + SPR_AMBIENT_OFFSET + PHARAOH_OFFSET, // sprambient
    GROUP_GRANARY_ANIM_PH = 47 + SPR_AMBIENT_OFFSET + PHARAOH_OFFSET,
    GROUP_WAREHOUSE_ANIM_PH = 51 + SPR_AMBIENT_OFFSET + PHARAOH_OFFSET,
//    GROUP_DOCK_WAITING = 55 + SPR_AMBIENT_OFFSET + PHARAOH_OFFSET,
//    GROUP_DOCK_UNLOADING = 56 + SPR_AMBIENT_OFFSET + PHARAOH_OFFSET,
    GROUP_MINES = 48 + SPR_AMBIENT_OFFSET + PHARAOH_OFFSET,
    GROUP_DANCERS = 6 + SPR_AMBIENT_OFFSET + PHARAOH_OFFSET,
    GROUP_JUGGLERS = 7 + SPR_AMBIENT_OFFSET + PHARAOH_OFFSET,
    GROUP_MUSICIANS = 9 + SPR_AMBIENT_OFFSET + PHARAOH_OFFSET,
    GROUP_FIGURE_FISH = 8 + SPR_AMBIENT_OFFSET + PHARAOH_OFFSET,
    GROUP_FIGURE_HIPPO = 22 + SPR_AMBIENT_OFFSET + PHARAOH_OFFSET,
    GROUP_FIGURE_ANTILOPE = 30 + SPR_AMBIENT_OFFSET + PHARAOH_OFFSET,
    GROUP_FIGURE_HUNTER2 = 36 + SPR_AMBIENT_OFFSET + PHARAOH_OFFSET,
    GROUP_SHIP_BUILDING_1 = 45 + SPR_AMBIENT_OFFSET + PHARAOH_OFFSET,
    GROUP_SHIP_BUILDING_2 = 52 + SPR_AMBIENT_OFFSET + PHARAOH_OFFSET,
    GROUP_SHIP_BUILDING_3 = 53 + SPR_AMBIENT_OFFSET + PHARAOH_OFFSET,
    GROUP_SHIP_BUILDING_4 = 54 + SPR_AMBIENT_OFFSET + PHARAOH_OFFSET,
    ...
    GROUP_BUTTON_EXCLAMATION = 193 + 66,
//    GROUP_SIDE_PANEL_PH = 121+66,
//    GROUP_SIDEBAR_BUTTONS_PH = 136+66,
    GROUP_PANEL_WINDOWS_PH = 300,
    GROUP_MESSAGE_ADVISOR_BUTTONS_BIG = 128 + 66 + 99999,

    GROUP_TERRAIN_GRASS_PH = 46 + PHARAOH_OFFSET, // terrain
    GROUP_TERRAIN_DEEPWATER = 61 + PHARAOH_OFFSET,
    GROUP_TERRAIN_GRASS_PH_EDGES = 64 + PHARAOH_OFFSET,
    GROUP_TERRAIN_FLOODPLAIN = 31 + PHARAOH_OFFSET,
    GROUP_TERRAIN_FLOODSYSTEM = 33 + PHARAOH_OFFSET,

    GROUP_DEBUG_ARROWPOST = 24 + PHARAOH_OFFSET,
    GROUP_DEBUG_WIREFRAME_TILE = 41 + PHARAOH_OFFSET,
    GROUP_SUNKEN_TILE = 20 + PHARAOH_OFFSET,
