...
static translation_string all_strings[] = {
  ...
  {TR_ADVISOR_PERCENTAGE_IN_MANORS, "Pourcentage de votre population dans les villas et palais est"},
  {TR_ADVISOR_PERCENTAGE_IN_SHANTIES, "Pourcentage de votre population dans les tentes et cabanes est"},
