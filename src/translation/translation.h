...
enum {
    ...
    TR_CONFIG_HIDE_NEW_GAME_TOP_MENU,
    TR_CONFIG_SAVE_YEAR_KINGDOME_RATING,
    ...
    TR_CONFIG_BUILDING_CLOSEST_ROAD,
    TR_CONFIG_FLOODPLAIN_RANDOM_GROW,
