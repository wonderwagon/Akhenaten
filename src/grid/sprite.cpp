...
io_buffer* iob_sprite_grid = new io_buffer([](io_buffer* iob) { iob->bind(BIND_SIGNATURE_GRID, &g_sprite_grid); });
io_buffer* iob_sprite_backup_grid
  = new io_buffer([](io_buffer* iob) { iob->bind(BIND_SIGNATURE_GRID, &g_sprite_grid_backup); });