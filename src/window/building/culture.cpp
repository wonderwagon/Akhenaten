...
void window_building_draw_theater(building_info_context* c) {
    ...
    if (b->data.entertainment.days1 > 0) {
        ...
        lang_text_draw_amount(8,
                              44,
                              2 * b->data.entertainment.days1,
                              c->x_offset + width + 32,
                              c->y_offset + 182,
                              FONT_NORMAL_BLACK_ON_DARK);
        lang_text_draw(
          72, 7 + b->data.entertainment.days3_or_play, c->x_offset + 32, c->y_offset + 202, FONT_NORMAL_BLACK_ON_DARK);
    } else {
...
void window_building_draw_amphitheater(building_info_context* c) {
    ...
    if (b->data.entertainment.days2 > 0) {
        ...
        lang_text_draw_amount(8,
                              44,
                              2 * b->data.entertainment.days2,
                              c->x_offset + width + 32,
                              c->y_offset + 202,
                              FONT_NORMAL_BLACK_ON_DARK);
        lang_text_draw(
          72, 7 + b->data.entertainment.days3_or_play, c->x_offset + 32, c->y_offset + 222, FONT_NORMAL_BLACK_ON_DARK);
    } else {
