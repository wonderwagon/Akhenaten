...
static int draw_background(void) {
    ...
    imagedrawnamespace::image_draw(image_id_from_group(GROUP_ADVISOR_ICONS) + 4, 10, 10);
...
static void draw_foreground(void) {
    ...
    for (int i = scrollbar.scroll_position; i < list->size; i++) {
        ...
        imagedrawnamespace::image_draw(image_id_from_group(GROUP_RESOURCE_ICONS) + image_offset, 24, y_offset + 58);
