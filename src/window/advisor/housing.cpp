...
static void draw_housing_table() {
    ...
    for (int i = 0; i <= 3; i++) {
        imagedrawnamespace::image_draw(image_id_from_group(GROUP_RESOURCE_ICONS) + goods_icons[i], 54, y_offset + 260 + (23 * i));
...
static int draw_background(void) {
    ...
    imagedrawnamespace::image_draw(image_id_from_group(GROUP_ADVISOR_ICONS) + 5, 555, 265);
