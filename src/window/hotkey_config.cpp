...
static void draw_background(void) {
    ...
    imagedrawnamespace::image_draw_fullscreen_background(image_id_from_group(GROUP_CONFIG));
    ...
    for (int i = 0; i < NUM_VISIBLE_OPTIONS; i++) {
        ...
        if (widget->action == HOTKEY_HEADER)
            ...
            if (mapping1->key) {
                ...
                text_draw_centered(keyname, HOTKEY_X_OFFSET_1 + 3, text_offset, HOTKEY_BTN_WIDTH - 6, FONT_NORMAL_WHITE,
                                   0);
            ...
            if (mapping2->key) {
                ...
                text_draw_centered(keyname, HOTKEY_X_OFFSET_2 + 3, text_offset, HOTKEY_BTN_WIDTH - 6, FONT_NORMAL_WHITE,
                                   0);
                graphics_reset_clip_rectangle();
            }
        }
