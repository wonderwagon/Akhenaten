...
static void draw_background(void) {
    ...
    text_draw_centered(translation_for(TR_HOTKEY_ALTERNATIVE_LABEL), HOTKEY_X_OFFSET_2, 55, HOTKEY_BTN_WIDTH,
        ...
        if (widget->action == HOTKEY_HEADER)
            ...
            if (widget->name_translation != TR_NONE) {
                text_draw(translation_for(widget->name_translation),
                          32, text_offset, FONT_NORMAL_BLACK_ON_DARK, 0);
            } else {
                lang_text_draw(widget->name_text_group, widget->name_text_id,
                               32, text_offset, FONT_NORMAL_BLACK_ON_DARK);
            }
            ...
            if (mapping1->key) {
                ...
                text_draw_centered(keyname, HOTKEY_X_OFFSET_1 + 3, text_offset, HOTKEY_BTN_WIDTH - 6, FONT_NORMAL_WHITE_ON_DARK,
                                   0);
            ...
            if (mapping2->key) {
                ...
                text_draw_centered(keyname, HOTKEY_X_OFFSET_2 + 3, text_offset, HOTKEY_BTN_WIDTH - 6, FONT_NORMAL_WHITE_ON_DARK,
                                   0);
                graphics_reset_clip_rectangle();
            }
        }
