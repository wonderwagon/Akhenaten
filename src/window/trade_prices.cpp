...
static void draw_background(void) {
    ...
    for (int i = 1; i < 16; i++) {
        ...
        text_draw_number_centered(trade_price_buy(i), 120 + 30 * i, 229, 30, FONT_SMALL_SHADED);
        text_draw_number_centered(trade_price_sell(i), 120 + 30 * i, 254, 30, FONT_SMALL_SHADED);
    }
