...
static void building_service_draw_info(object_info& c, int help_id, const char* type, int group_id, e_figure_type ftype) {
    c.help_id = help_id;
...
void building_dentist_draw_info(object_info& c) {
    building_service_draw_info(c, 65, "dentist", e_text_building_dentist, FIGURE_DENTIST);
}
