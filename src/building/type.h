...
enum {
    ...
    BUILDING_FORT_MOUNTED = 45, BUILDING_FORT_INFANTRY = 40,
    ...
    BUILDING_ROADBLOCK = 115, BUILDING_HUNTING_LODGE = 115,
    //
    BUILDING_FERRY = 136,
    //
    BUILDING_ROADBLOCK_ACTUAL = 138,
    //
    ...
    //
    BUILDING_VILLAGE_PALACE = 188,
    BUILDING_TOWN_PALACE = 189,
    BUILDING_CITY_PALACE = 190,
    //
    BUILDING_CATTLE_RANCH = 194,
    BUILDING_REED_GATHERER = 195,
    BUILDING_FARM_FIGS = 196,
    //
