...
//
//    if (!SaveFileIO::load_mission(scenario_id, true))
//        return false;
//
...
//
//    clear_scenario_data();
//    if (!SaveFileIO::load(filename, true))
//        return false;
//
//    // post-load
//    trade_prices_reset();
...
//    return true;
//}
//bool game_load_mission(const char *filename, bool start_immediately) {
...
//    return true;
//}
//bool game_load_mission(const uint8_t *scenario_name, bool start_immediately) {
//    if (!pre_load()) return false;
//
//    return false; // TODO
//
...
//        return true;
//}
//bool game_load_mission(int scenario_id, bool start_immediately) {
//
////    if (!pre_load()) return false;
//
//    // pak loading
...
//bool game_file_load_saved_game(const char *filename, bool start_immediately) {
//    if (!SaveFileIO::load(filename, true))
//        return false;
//
//    if (start_immediately)
