...
void tutorial_on_add_to_storageyard() {
    ...
    } else if (!g_tutorials_flags.pharaoh.pottery_made && city_resource_count(RESOURCE_POTTERY) >= 2) {
    ...
    } else if (!g_tutorials_flags.pharaoh.beer_made && city_resource_count(RESOURCE_BEER) >= 3) {
