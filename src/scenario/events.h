...
typedef struct {
    ...
    int8_t type;
    int8_t month;
    int16_t item_THISTIME;
    int16_t item_1;
    int16_t item_2;
    int16_t item_3;
    int16_t amount_THISTIME;
    int16_t amount_FIXED;
    int16_t amount_MIN;
    int16_t amount_MAX;
    int16_t year_or_month_THISTIME;
    int16_t year_or_month_FIXED;
    int16_t year_or_month_MIN;
    int16_t year_or_month_MAX;
    int16_t city_or_marker_THISTIME;
    int16_t city_or_marker_FIXED;
    int16_t city_or_marker_MIN;
    int16_t city_or_marker_MAX;
