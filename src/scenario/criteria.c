...
int winning_population() {
    if (!scenario.win_criteria.population.enabled)
        return 0;
    return scenario.win_criteria.population.goal;
}
int winning_culture() {
    if (!scenario.win_criteria.culture.enabled)
        return 0;
    return scenario.win_criteria.culture.goal;
}
int winning_prosperity() {
    if (!scenario.win_criteria.prosperity.enabled)
        return 0;
    return scenario.win_criteria.prosperity.goal;
}
int winning_peace() {
    if (!scenario.win_criteria.peace.enabled)
        return 0;
    return scenario.win_criteria.peace.goal;
}
int winning_favor() {
    if (!scenario.win_criteria.favor.enabled)
        return 0;
    return scenario.win_criteria.favor.goal;
}
int winning_housing() {
    if (!scenario.win_criteria.ph_goal1.enabled)
        return 0;
    return scenario.win_criteria.ph_goal1.goal;
}
int winning_houselevel() {
    if (!scenario.win_criteria.ph_goal2.enabled)
        return 0;
    return scenario.win_criteria.ph_goal2.goal;
}
