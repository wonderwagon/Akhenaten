...
enum e_config_key {
    ...
    CONGIG_GP_CH_BUILDING_CHICKPEAS_FARM,
    CONGIG_GP_CH_BUILDING_LETTUCE_FARM,
    CONGIG_GP_CH_BUILDING_POMEGRANATES_FARM,
    CONGIG_GP_CH_BUILDING_FIGS_FARM,
    CONFIG_GP_CH_RESOURCE_FIGS,
    CONGIG_GP_CH_BUILDING_GRAIN_FARM,
    CONFIG_GP_CH_RESOURCE_GRAIN,
    CONGIG_GP_CH_BUILDING_CATTLE_RANCH,
    CONFIG_GP_CH_RESOURCE_MEAT,
    CONGIG_GP_CH_BUILDING_BRICKS_WORKSHOP,
    CONFIG_GP_CH_RESOURCE_BRICKS,

    CONGIG_GP_CH_BUILDING_WORK_CAMP,
    CONGIG_GP_CH_BUILDING_GOLD_MINE,
    CONGIG_GP_CH_BUILDING_QUARRY_SANDSTONE,
    CONGIG_GP_CH_BUILDING_QUARRY_GRANITE,
    CONGIG_GP_CH_BUILDING_QUARRY_STONE,
    CONGIG_GP_CH_BUILDING_QUARRY_LIMESTONE,
