...
void img_sprite(int image_id, int x, int y, color color_mask = COLOR_MASK_NONE, float scale = 1.0f);
void img_ornament(int image_id, int base_id, int x, int y, color color_mask = COLOR_MASK_NONE, float scale = 1.0f);
void img_from_below(int image_id, int x, int y, color color_mask = COLOR_MASK_NONE, float scale = 1.0f);
void img_letter(font_t font, int letter_id, int x, int y, color color_mask = COLOR_MASK_NONE, float scale = 1.0f);
void img_background(int image_id, float scale = 1.0f);
void isometric(int image_id, vec2i pos, color color_mask = COLOR_MASK_NONE, float scale = 1.0f);
void isometric(int image_id, int x, int y, color color_mask = COLOR_MASK_NONE, float scale = 1.0f);
void isometric_from_drawtile(int image_id, int x, int y, color color_mask = COLOR_MASK_NONE);
} // namespace ImageDraw
