...
static void draw_tooltip(tooltip_context *c) {
    switch (c->type) {
        case TOOLTIP_BUTTON:
            draw_button_tooltip(c); break;
        case TOOLTIP_OVERLAY:
            draw_overlay_tooltip(c); break;
        case TOOLTIP_TILES:
            draw_tile_tooltip(c); break;
        case TOOLTIP_SENATE:
            draw_senate_tooltip(c); break;
    }
}
