...
void draw_isometrics(vec2i pixel, map_point point, view_context &ctx);
void draw_ornaments(vec2i pixel, map_point point, view_context &ctx);
void draw_figures(vec2i pixel, map_point point, view_context &ctx);
...
void draw_figures_overlay(vec2i pixel, map_point point, view_context &ctx);
