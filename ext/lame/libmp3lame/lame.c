...
lame_init_params(lame_global_flags * gfp)
{
    ...
    if (gfp->samplerate_out == 0 && (cfg->vbr == vbr_mt || cfg->vbr == vbr_mtrh)) {
        ...
        = { {48000, 0.0f,  6.5f,  0.0f, 6.5f, 23700},
            {44100, 0.0f,  6.5f,  0.0f, 6.5f, 21780},
            {32000, 6.5f,  8.0f,  5.2f, 6.5f, 15800},
            {24000, 8.0f,  8.5f,  5.2f, 6.0f, 11850},
            {22050, 8.5f,  9.01f, 5.2f, 6.5f, 10892},
            {16000, 9.01f, 9.4f,  4.9f, 6.5f,  7903},
            {12000, 9.4f,  9.6f,  4.5f, 6.0f,  5928},
            {11025, 9.6f,  9.9f,  5.1f, 6.5f,  5446},
            { 8000, 9.9f,  10.f,  4.9f, 6.5f,  3952},
        };
        for (i = 2; i < 9; ++i) {
