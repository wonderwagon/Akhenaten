...
lame_init_params(lame_global_flags * gfp)
{
    ...
    if (gfp->samplerate_out == 0 && (cfg->vbr == vbr_mt || cfg->vbr == vbr_mtrh)) {
        ...
        = { {48000.f, 0.0f,6.5f,  0.0,6.5f, 23700.f}
          , {44100.f, 0.0f,6.5f,  0.0,6.5f, 21780.f}
          , {32000.f, 6.5f,8.0f,  5.2,6.5f, 15800.f}
          , {24000.f, 8.0f,8.5f,  5.2,6.0f, 11850.f}
          , {22050.f, 8.5f,9.01f, 5.2,6.5f, 10892.f}
          , {16000.f, 9.01f,9.4f, 4.9,6.5f,  7903.f}
          , {12000.f, 9.4f,9.6f,  4.5,6.0f,  5928.f}
          , {11025.f, 9.6f,9.9f,  5.1,6.5f,  5446.f}
          , { 8000.f, 9.9f,10.f,  4.9,6.5f,  3952.f}
        };
        for (i = 2; i < 9; ++i) {
